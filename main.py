...
icon = Image.open("C:/Users/Dhivakaran/Phonepe_Project/Images/logo.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Dhivakaran",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This dashboard app is created by *Dhivakaran*!
...
# MENU 1 - HOME
if selected == "Home":
    st.image(icon, width=5*100)
    st.markdown("# :violet[Data Visualization and Exploration of PhonePe Pulse]")
...
if selected == "Explore Data":
    ...
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv("C:/Users/Dhivakaran/Phonepe_Project/statenames.csv")
            df1.State = df2
...
if selected == "About":
    ...
    st.write("https://github.com/Dhivakaran14/PhonePe-Pulse-Data-Visualisation")
